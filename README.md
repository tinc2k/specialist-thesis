...
Nove generacije korisnika i uređaja, te evolucija mobilne i Internet infrastrukture postavljaju pred struku brojne složene izazove. Trend porasta broja i vrsta različitih uređaja koji omogućuju pristup Internetu sugerira potrebu fleksibilnosti današnjih web aplikacija u pogledu podržanih veličina ekrana i vrsta ulaznih uređaja, u koje uz površinu osjetljivu na dodir sve češće ubrajamo GPS prijamnik, akcelerometar, kamere, mikrofon, te brojne druge.
